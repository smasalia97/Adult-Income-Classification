...
1. To run final.py, open terminal in the directory where file is present and run the command "python final.py".
...
OPTIONAL - For points 1, one can just install code runner extension on VS Code, this would same time.
